  ...
  return (
    <section style={{ background: '#fff', padding: '70px 0' }}>
      <div className="container-main">
        ...
        <motion.p initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.1 }} style={{ color: '#6B6B6B', textAlign: 'center', marginBottom: 48, fontSize: 16 }}>
        ...
        <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-50px" }} transition={{ duration: 0.7 }} className="grid grid-cols-1 md:grid-cols-[3fr_1fr] gap-5 mb-5">
          ...
          <motion.div whileHover={{ scale: 1.02 }} style={{ background: '#F97316', borderRadius: 24, padding: 40, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
        ...
        <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-50px" }} transition={{ duration: 0.7, delay: 0.2 }} className="grid grid-cols-1 md:grid-cols-3 gap-5">
          <motion.div whileHover={{ scale: 1.02 }} style={{ background: '#3B82F6', borderRadius: 24, padding: 40, display: 'flex', flexDirection: 'column', justifyContent: 'center', position: 'relative', overflow: 'hidden' }}>
          ...
          <motion.div whileHover={{ scale: 1.02 }} style={{ background: '#0D0D0D', borderRadius: 24, padding: 40, display: 'flex', flexDirection: 'column', justifyContent: 'center', position: 'relative', overflow: 'hidden' }}>
