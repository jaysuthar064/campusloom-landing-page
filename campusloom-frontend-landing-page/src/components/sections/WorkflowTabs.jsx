...
export default function WorkflowTabs() {
  const tabs = [
    { 
      ...
      title: 'Track student presence effortlessly.', 
      desc: 'Automate daily attendance tracking with comprehensive digital registers, eliminating manual errors and saving hours of administrative work for teachers.',
    ...
    { 
      ...
      title: 'Streamline academic workflows.', 
      desc: 'Empower your educators with dedicated portals to manage lesson plans, grade assignments, and communicate with parents seamlessly.',
    ...
    <section style={{ background: '#fff', padding: '100px 0' }}>
      <div className="container-main">
        <h2 style={{ color: '#1A1A1A', fontSize: 'clamp(32px, 4vw, 48px)', fontWeight: 700, textAlign: 'center', marginBottom: 12, letterSpacing: '-0.02em' }}>
          All your academic workflows in a single place.
        </h2>
            ...
            <div style={{ background: '#fff', borderRadius: 16, padding: 24, boxShadow: '0 4px 20px rgba(0,0,0,0.04)' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                <div style={{ width: 160, height: 160, position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  ...
                  <div style={{ fontSize: 24, fontWeight: 800, color: '#1A1A1A', fontFamily: "'Bricolage Grotesque'" }}>92%</div>
                </div>
